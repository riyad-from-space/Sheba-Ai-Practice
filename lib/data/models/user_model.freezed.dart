...
class _$UserModelImpl implements _UserModel {
  const _$UserModelImpl({required this.username, required this.email, this.id});
  ...
  @override
  String toString() {
    return 'UserModel(username: $username, email: $email, id: $id)';
  }
...
abstract class $RegisterRequestCopyWith<$Res> {
  ...
  @useResult
  $Res call({String username, String email, String password, String password2});
}
...
class _$RegisterRequestImpl implements _RegisterRequest {
  ...
  @override
  String toString() {
    return 'RegisterRequest(username: $username, email: $email, password: $password, password2: $password2)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, username, email, password, password2);
...
abstract class _RegisterRequest implements RegisterRequest {
  const factory _RegisterRequest(
      ...
      required final String password2}) = _$RegisterRequestImpl;
...
class _$LoginResponseImpl implements _LoginResponse {
  const _$LoginResponseImpl({required this.access, required this.refresh});
...
abstract class _LoginResponse implements LoginResponse {
  const factory _LoginResponse(
      ...
      required final String refresh}) = _$LoginResponseImpl;
